...
def create_arg_parser():
    ...
    parser.add_argument(
        "-i", "--train_file", default="train.txt", type=str, help="Input file to learn from (default train.txt)"
    )
    parser.add_argument(
        "-d", "--dev_file", type=str, default="dev.txt", help="Separate dev set to read in (default dev.txt)"
    )
